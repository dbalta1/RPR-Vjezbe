...
public class UserForm extends BorderPane {
    ...
    private ListView<com.example.probaprogram.Korisnik> userList;
    ...
    private ButtonBar createButtonBar() {
        ...
        dodajButton.setOnAction(event -> {
            com.example.probaprogram.Korisnik newUser = new com.example.probaprogram.Korisnik();
    ...
    private void showUserDetails(com.example.probaprogram.Korisnik user) {
